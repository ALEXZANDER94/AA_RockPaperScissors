...
UCLASS()
class ROCKPAPERSCISSORS_API APlayerPawn : public APawn
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure)
	FRotator GetPlayerChoiceRotation() { return ChoiceRotation; }

	UFUNCTION(BlueprintCallable)
	void SetPlayerChoiceRotation(FRotator PlayerRot) { ChoiceRotation = PlayerRot; }
